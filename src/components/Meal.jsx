      ...
      <div className="flex fixed w-full bottom-1 overflow-hidden">
        <div className="flex flex-nowrap overflow-x-auto -mb-2 sm:mb-0 pl-3">
          ...
          {favoriteProducts.map((product) => (
            <div
              key={product.id}
              className="whitespace-nowrap text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 font-medium rounded-full text-sm px-3 py-2 mr-1 mb-2 cursor-pointer"
            >
              {product.title}
            </div>
          ))}
