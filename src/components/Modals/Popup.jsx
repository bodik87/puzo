                ...
                <Dialog.Panel className="w-full max-w-lg transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-lg transition-all">
                  ...
                  <div className="flex flex-col justify-center gap-2">
                    <div className="mt-6 flex justify-center">
                      <button
                        type="button"
                        className="btn bg-blue-700 hover:bg-blue-700/90 text-xl py-5"
                        onClick={closeModal}
                      >
                        {ADD_AGAIN}
                      </button>
                    ...
                    <div className="mt-2 flex gap-2">
                      <button
                        type="button"
                        className="btn bg-red-500 hover:bg-red-500/90 flex flex-nowrap text-xl py-5"
                        onClick={closeModal}
                      >
                        {DELETE}
                      </button>
                      <button
                        type="button"
                        className="btn bg-yellow-500 hover:bg-yellow-500/90 active:hover:bg-yellow-800 text-xl py-5"
                        onClick={closeModal}
                      >
                        {EDIT}
                      </button>
